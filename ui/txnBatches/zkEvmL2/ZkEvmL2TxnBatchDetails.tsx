...
const ZkEvmL2TxnBatchDetails = ({ query }: Props) => {
  ...
  return (
    <Grid
      ...
      overflow="hidden"
    >
      <DetailsInfoItem title="Tx batch number" isLoading={isPlaceholderData}>
      ...
      <DetailsInfoItem title="Status" isLoading={isPlaceholderData}>
        <VerificationSteps
      ...
      <DetailsInfoItem title="Timestamp" isLoading={isPlaceholderData}>
        {data.timestamp ? (
          <DetailsTimestamp
      ...
      <DetailsInfoItem title="Verify tx hash" isLoading={isPlaceholderData}>
        {data.verify_tx_hash ? (
          <TxEntityL1
            isLoading={isPlaceholderData}
      ...
      <DetailsInfoItem title="Transactions" isLoading={isPlaceholderData}>
      ...
      <DetailsInfoItem title="Sequence tx hash" isLoading={isPlaceholderData}>
