...
export type TxQuery = UseQueryResult<
  Transaction,
...
export default function useTxQuery(params?: Params): TxQuery {
  ...
  const handleStatusUpdateMessage: SocketMessage.TxStatusUpdate["handler"] =
  ...
  const channel = useSocketChannel({
    ...
    isDisabled:
      isPending || isPlaceholderData || isError || data.status !== null,
  });
  useSocketMessage({
    channel,
    event: "collated",
