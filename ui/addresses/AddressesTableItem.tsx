...
const AddressesTableItem = ({
  ...
  const addressBalance = BigNumber(item.coin_balance).div(
    BigNumber(10 ** config.chain.currency.decimals)
  );
    ...
    <Tr>
      ...
      <Td isNumeric>
        <Skeleton isLoaded={!isLoading} display="inline-block" maxW="100%">
          ...
          <Text lineHeight="24px" variant="secondary" as="span">
            {addressBalanceChunks[1]}
          </Text>
        </Skeleton>
      </Td>
