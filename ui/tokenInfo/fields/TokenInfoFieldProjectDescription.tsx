...
const TokenInfoFieldProjectDescription = ({ control, isReadOnly }: Props) => {
  const renderControl: ControllerProps<
    Fields,
    "project_description"
      ...
      return (
        ...
        >
          ...
          <Text variant="secondary" fontSize="sm" mt={1}>
            Introduce or summarize the project’s operation/goals in a maximum of
            300 characters. The description should be written in a neutral point
            of view and must exclude unsubstantiated claims unless proven
            otherwise.
          </Text>
        </FormControl>
      );
