      ...
      ({ field, fieldState, formState }) => {
        return (
          <FormControl
            ...
            id={field.name}
            size={{ base: "md", lg: "lg" }}
            sx={{ ".chakra-input__group input": { pr: "60px" } }}
          >
            <InputGroup>
              <Input
                {...field}
              ...
              />
              <InputPlaceholder
                text={SETTINGS[name].label}
                error={fieldState.error}
              />
              <InputRightElement h="100%">
                <IconSvg
                  name={SETTINGS[name].icon}
                  boxSize={6}
                  color={field.value ? SETTINGS[name].color : "#718096"}
                />
              </InputRightElement>
            </InputGroup>
          </FormControl>
