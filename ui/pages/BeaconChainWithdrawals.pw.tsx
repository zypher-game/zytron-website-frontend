...
test("base view +@mobile", async ({ mount, page }) => {
  ...
  await page.route(WITHDRAWALS_API_URL, (route) =>
    route.fulfill({
      status: 200,
  ...
  await page.route(WITHDRAWALS_COUNTERS_API_URL, (route) =>
    route.fulfill({
      status: 200,
      body: JSON.stringify({
        withdrawal_count: "111111",
        withdrawal_sum: "1010101010110101001101010",
      }),
    })
  );
