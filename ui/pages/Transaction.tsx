...
const TransactionPageContent = () => {
  ...
  const showDegradedView =
    publicClient && (isError || isPlaceholderData) && errorUpdateCount > 0;
    ...
    return [
      ...
      txInterpretation.isEnabled && txInterpretation.provider === "noves"
        ? {
            id: "asset_flows",
            title: "Asset Flows",
            component: <TxAssetFlows hash={hash} />,
          }
        : undefined,
      config.features.suave.isEnabled && data?.wrapped
        ? {
      ...
      config.features.userOps.isEnabled
        ? {
            ...
            component: <TxUserOps txQuery={txQuery} />,
          }
        : undefined,
      {
        id: "internal",
        title: "Internal txns",
        component: <TxInternals txQuery={txQuery} />,
      },
      txQuery.data?.blob_versioned_hashes?.length
        ? {
            id: "blobs",
            title: "Blobs",
            component: <TxBlobs txQuery={txQuery} />,
          }
        : undefined,
      ...
      { id: "state", title: "State", component: <TxState txQuery={txQuery} /> },
      {
        id: "raw_trace",
        title: "Raw trace",
        component: <TxRawTrace txQuery={txQuery} />,
      },
    ].filter(Boolean);
  })();
