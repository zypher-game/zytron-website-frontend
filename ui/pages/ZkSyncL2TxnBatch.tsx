...
const ZkSyncL2TxnBatch = () => {
      ...
      [
        {
          id: "index",
          title: "Details",
          component: <ZkSyncL2TxnBatchDetails query={batchQuery} />,
        },
        {
          id: "txs",
          title: "Transactions",
  ...
  const backLink = React.useMemo(() => {
    const hasGoBackLink =
      appProps.referrer && appProps.referrer.endsWith("/batches");
  ...
  const hasPagination =
    !isMobile && batchTxsQuery.pagination.isVisible && tab === "txs";
    ...
    <>
      ...
      {batchQuery.isPlaceholderData ? (
        ...
        <RoutedTabs
          ...
          rightSlot={
            hasPagination ? <Pagination {...batchTxsQuery.pagination} /> : null
          }
