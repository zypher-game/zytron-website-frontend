...
const PrivateAddressTags = () => {
  const {
    ...
    options: {
      ...
      placeholderData: {
        items: Array(5).fill(PRIVATE_TAG_ADDRESS),
  ...
  return (
    <>
      <AccountPageDescription>
        Use private address tags to track any addresses of interest. Private
        tags are saved in your account and are only visible when you are logged
        in.
      </AccountPageDescription>
      <DataListDisplay
        isError={isError}
