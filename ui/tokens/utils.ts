...
export const SORT_OPTIONS: Array<Option<TokensSortingValue>> = [
  ...
  {
    title: "On-chain market cap descending",
    id: "circulating_market_cap-desc",
  },
];

export const getTokenFilterValue = getFilterValuesFromQuery<TokenType>.bind(
  null,
  TOKEN_TYPE_IDS
);
...
export const getBridgedChainsFilterValue =
  getFilterValuesFromQuery<string>.bind(null, bridgedTokensChainIds);
