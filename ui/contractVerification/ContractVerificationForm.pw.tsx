...
test("flatten source code method +@dark-mode +@mobile", async ({
  mount,
  page,
}) => {
...
test.describe("sourcify", () => {
  ...
  testWithSocket(
    ...
    async ({ mount, page, createSocket }) => {
      ...
      const contractNameOption = page.getByRole("button", {
        name: /MockERC20/i,
      });
