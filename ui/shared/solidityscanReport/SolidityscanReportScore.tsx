  ...
  return (
    <Flex className={className} alignItems="center">
      ...
      >
        ...
        >
          <IconSvg
            name={score < 80 ? "score/score-not-ok" : "score/score-ok"}
            boxSize={5}
            color={scoreColor}
          />
        </Center>
      ...
      <Box>
        <Flex>
          <Text color={scoreColor} fontSize="lg" fontWeight={500}>
            {score}
          </Text>
          <Text
            color={yetAnotherGrayColor}
            fontSize="lg"
            fontWeight={500}
            whiteSpace="pre"
          >
        ...
        <Text color={scoreColor} fontWeight={500}>
