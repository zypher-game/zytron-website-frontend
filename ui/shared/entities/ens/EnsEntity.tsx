...
const Icon = (props: IconProps) => {
  return <EntityBase.Icon {...props} name={props.iconName ?? "ENS_slim"} />;
};

type ContentProps = Omit<EntityBase.ContentBaseProps, "text"> &
  Pick<EntityProps, "name">;

const Content = chakra((props: ContentProps) => {
  return <TruncatedValue isLoading={props.isLoading} value={props.name} />;
});
...
const Copy = (props: CopyProps) => {
  return <EntityBase.Copy {...props} text={props.name} />;
};
