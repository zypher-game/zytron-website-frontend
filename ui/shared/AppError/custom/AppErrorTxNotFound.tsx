  ...
  return (
    <>
      ...
      <OrderedList mt={3} spacing={3}>
        <ListItem>
          If you have just submitted this transaction please wait for at least
        ...
        <ListItem>
          During times when the network is busy (i.e during ICOs) it can take a
          while for your transaction to propagate through the network and for us
          to index it.
        </ListItem>
        <ListItem>
          <span>
