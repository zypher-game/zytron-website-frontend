...
const GetitAdPlugin = dynamic(
  () => import("getit-sdk").then((module) => module.GetitAdPlugin),
  { ssr: false }
);

const GETIT_API_KEY =
  "ZmGXVvwYUAW4yXL8RzWQHNKmpSyQmt3TDXsXUxqFqXPdoaiSSFyca3BOyunDcWdyOwTkX3UVVQel28qbjoOoWPxYVpPdNzbUNkAHyFyJX7Lk9TVcPDZKTQmwHlSMzO3a";

const GetitBannerContent = ({
  address,
  className,
}: {
  address?: string;
...
const GetitBannerWithWalletAddress = ({
  className,
}: {
  className?: string;
}) => {
