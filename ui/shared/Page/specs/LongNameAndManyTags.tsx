...
const LongNameAndManyTags = () => {
  const tokenData: TokenInfo = {
    ...
    symbol:
      "BatcoiRing ding ding daa baa Baa aramba baa bom baa barooumba Wh-wha-what&#39;s going on-on? Ding, ding This is the Crazy Frog Ding, ding Bem, bem! Ring ding ding ding ding ding Ring ding ding ding bem bem bem Ring ding ding ding ding ding Ring ding ding ding",
    total_supply: "13747",
    type: "ERC-721",
  };
  ...
  return (
    <PageTitle
      ...
      beforeTitle={<TokenEntity.Icon token={tokenData} iconSize="lg" />}
