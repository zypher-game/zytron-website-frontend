...
const ContractSecurityReport = ({ securityReport }: Props) => {
  ...
  const totalIssues = Object.values(
    issueSeverityDistribution as Record<string, number>
    ...
    <Popover isOpen={isOpen} onClose={onClose} placement="bottom-start" isLazy>
      ...
      <PopoverContent w={{ base: "100vw", lg: "328px" }}>
        <PopoverBody px="26px" py="20px" fontSize="sm">
          <Box mb={5}>
            The security score was derived from evaluating the smart contracts
            of a protocol on the {config.chain.name} network.
          </Box>
