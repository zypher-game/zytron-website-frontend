    ...
    switch (type) {
      ...
      case ContractListTypes.ANALYZED:
        return contracts
          ...
          .sort(
            (a, b) =>
              parseFloat(b.solidityScanReport?.scan_summary.score_v2 ?? "0") -
              parseFloat(a.solidityScanReport?.scan_summary.score_v2 ?? "0")
          );
              ...
              {type === ContractListTypes.ANALYZED && (
                <Box gridColumn={1}>
                  <ContractSecurityReport
                    securityReport={contract.solidityScanReport}
                  />
                </Box>
              )}
              <AddressEntity
