...
const API_URL =
  buildApiUrl("address_token_transfers", { hash: CURRENT_ADDRESS }) +
  "?token=0x1189a607CEac2f0E14867de4EB15b15C9FFB5859";

const hooksConfig = {
  router: {
    query: {
      hash: CURRENT_ADDRESS,
      token: "0x1189a607CEac2f0E14867de4EB15b15C9FFB5859",
    },
  },
};
...
test.describe("socket", () => {
  test("without overload", async ({ mount, page, createSocket }) => {
    ...
    socketServer.sendMessage(socket, channel, "token_transfer", {
      token_transfers: [tokenTransferMock.erc1155B, tokenTransferMock.erc1155C],
    });
  ...
  test("without overload, with filters", async ({
    ...
    socketServer.sendMessage(socket, channel, "token_transfer", {
      token_transfers: [tokenTransferMock.erc1155B, tokenTransferMock.erc20],
    });
