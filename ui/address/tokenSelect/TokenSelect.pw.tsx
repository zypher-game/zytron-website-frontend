...
const TOKENS_ERC20_API_URL =
  buildApiUrl("address_tokens", { hash: "1" }) + "?type=ERC-20";
const TOKENS_ERC721_API_URL =
  buildApiUrl("address_tokens", { hash: "1" }) + "?type=ERC-721";
const TOKENS_ER1155_API_URL =
  buildApiUrl("address_tokens", { hash: "1" }) + "?type=ERC-1155";
const TOKENS_ER404_API_URL =
  buildApiUrl("address_tokens", { hash: "1" }) + "?type=ERC-404";
  ...
  await page.route(
    ...
    async (route) =>
      route.fulfill({
        status: 200,
        body: JSON.stringify({
          items: [tokensMock.erc20LongSymbol, tokensMock.erc20BigAmount],
        }),
      }),
    { times: 1 }
  );
