...
const BALANCE_HISTORY_API_URL = buildApiUrl("address_coin_balance", {
  hash: addressHash,
});
const BALANCE_HISTORY_CHART_API_URL = buildApiUrl(
...
test("base view +@dark-mode +@mobile", async ({ mount, page }) => {
  ...
  await page.waitForFunction(() => {
    return (
      document
        .querySelector('path[data-name="chart-Balances-small"]')
