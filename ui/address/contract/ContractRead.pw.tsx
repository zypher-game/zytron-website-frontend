...
const CONTRACT_READ_METHODS_API_URL =
  buildApiUrl("contract_methods_read", { hash: addressHash }) +
  "?is_custom_abi=false";
const CONTRACT_QUERY_METHOD_API_URL =
  buildApiUrl("contract_method_query", { hash: addressHash }) +
  "?is_custom_abi=false";
const hooksConfig = {
  router: {
...
test("base view +@mobile +@dark-mode", async ({ mount, page }) => {
  ...
  await component
    ...
    .fill("0xa113Ce24919C08a26C952E81681dAc861d6a2466");
