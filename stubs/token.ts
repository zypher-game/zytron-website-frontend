...
export const getTokenHoldersStub = (
  type?: TokenType,
  pagination: TokenHoldersPagination | null = null
): TokenHolders => {
  switch (type) {
    case "ERC-721":
      return generateListStub<"token_holders">(TOKEN_HOLDER_ERC_20, 50, {
        next_page_params: pagination,
      });
    case "ERC-1155":
      return generateListStub<"token_holders">(TOKEN_HOLDER_ERC_1155, 50, {
        next_page_params: pagination,
      });
    case "ERC-404":
      return generateListStub<"token_holders">(TOKEN_HOLDER_ERC_1155, 50, {
...
export const getTokenInstanceHoldersStub = (
  type?: TokenType,
  pagination: TokenHoldersPagination | null = null
): TokenHolders => {
  switch (type) {
    case "ERC-721":
      return generateListStub<"token_instance_holders">(
        TOKEN_HOLDER_ERC_20,
        10,
        { next_page_params: pagination }
      );
...
export const getTokenTransfersStub = (
  ...
  switch (type) {
    case "ERC-721":
      return generateListStub<"token_transfers">(TOKEN_TRANSFER_ERC_721, 50, {
        next_page_params: pagination,
      });
    case "ERC-1155":
      return generateListStub<"token_transfers">(TOKEN_TRANSFER_ERC_1155, 50, {
        next_page_params: pagination,
      });
    case "ERC-404":
      return generateListStub<"token_transfers">(TOKEN_TRANSFER_ERC_404, 50, {
        next_page_params: pagination,
      });
    default:
      return generateListStub<"token_transfers">(TOKEN_TRANSFER_ERC_20, 50, {
        next_page_params: pagination,
      });
  }
};
...
export const getTokenInstanceTransfersStub = (
  ...
  switch (type) {
    case "ERC-721":
      return generateListStub<"token_instance_transfers">(
