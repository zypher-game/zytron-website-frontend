...
type Mount = <HooksConfig extends JsonObject>(
...
interface Options extends JsonObject {
  hooksConfig?: {
    router: Partial<
      Pick<typeof router, "query" | "isReady" | "asPath" | "pathname">
    >;
  };
}
...
const fixture: TestFixture<RenderFixture, { mount: Mount }> = async (
  { mount },
  use
) => {
  await use((component, options, props) => {
    return mount(<TestApp {...props}>{component}</TestApp>, options);
  });
};
