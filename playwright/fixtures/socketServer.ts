...
export const createSocket: TestFixture<
  CreateSocketFixture,
  { page: Page }
> = async ({ page }, use) => {
...
export function sendMessage(
  ...
  channel: Channel,
  msg: "coin_balance",
  payload: { coin_balance: AddressCoinBalanceHistoryItem }
): void;
export function sendMessage(
  socket: WebSocket,
  channel: Channel,
...
export function sendMessage(
  socket: WebSocket,
  channel: Channel,
  msg: "updated_token_balances_erc_20",
  payload: AddressTokensBalancesSocketMessage
): void;
export function sendMessage(
  socket: WebSocket,
  channel: Channel,
  msg: "updated_token_balances_erc_721",
  payload: AddressTokensBalancesSocketMessage
): void;
export function sendMessage(
  socket: WebSocket,
  channel: Channel,
  msg: "updated_token_balances_erc_1155",
  payload: AddressTokensBalancesSocketMessage
): void;
export function sendMessage(
  socket: WebSocket,
  channel: Channel,
  msg: "updated_token_balances_erc_404",
  payload: AddressTokensBalancesSocketMessage
): void;
export function sendMessage(
  socket: WebSocket,
...
export function sendMessage(
  socket: WebSocket,
  channel: Channel,
  msg: "pending_transaction",
  payload: { pending_transaction: number }
): void;
export function sendMessage(
  socket: WebSocket,
  channel: Channel,
  msg: "pending_transaction",
  payload: { pending_transactions: Array<Transaction> }
): void;
export function sendMessage(
  socket: WebSocket,
  channel: Channel,
  msg: "new_block",
  payload: NewBlockSocketResponse
): void;
export function sendMessage(
  socket: WebSocket,
  channel: Channel,
  msg: "verification_result",
  payload: SmartContractVerificationResponse
): void;
export function sendMessage(
  socket: WebSocket,
  channel: Channel,
  msg: "total_supply",
  payload: { total_supply: number }
): void;
export function sendMessage(
  socket: WebSocket,
  channel: Channel,
  msg: "changed_bytecode",
  payload: Record<string, never>
): void;
export function sendMessage(
  socket: WebSocket,
  channel: Channel,
  msg: "smart_contract_was_verified",
  payload: Record<string, never>
): void;
export function sendMessage(
  socket: WebSocket,
  channel: Channel,
  msg: "token_transfer",
  payload: { token_transfers: Array<TokenTransfer> }
): void;
export function sendMessage(
  socket: WebSocket,
  channel: Channel,
